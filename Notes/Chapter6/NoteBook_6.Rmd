...
```{r}
inference(sp, est = "proportion", success = "yes", method = "theoretical", conflevel = 0.9, type = "ci")
```

* Two-sided Hypothesis Testing

```{r}
inference(sp, est = "proportion", success = "yes", method = "simulation", type = "ht", null = 0.88, alternative = "twosided")
```

* One-sided Hypothesis Testing

```{r}
inference(sp, est = "proportion", success = "yes", method = "simulation", type = "ht", null = 0.88, alternative = "greater")
```